...
class WorkSchedule(models.Model):
    ...
    grace_period_minutes = models.PositiveIntegerField(
        default=5,
        verbose_name="Ruxsat etilgan muhlat (daqika)",
        help_text="Ish boshlanish vaqtidan keyin shuncha daqiqa kechikishga ruxsat",
    )
    # 0=Dushanba, 1=Seshanba, ..., 6=Yakshanba (Python weekday)
    working_days = models.CharField(
        max_length=20,
        default="0,1,2,3,4",
        help_text="Ish kunlari: vergul bilan ajratilgan (0=Du, 1=Se, 2=Ch, 3=Pa, 4=Ju, 5=Sh, 6=Ya). Masalan 0,1,2,3,4 = Du-Ju",
    )
...
class Employee(models.Model):
    ...
    work_start_time = models.TimeField(help_text="Ish boshlanish (grafik tanlanmasa ishlatiladi)")
    work_end_time = models.TimeField(help_text="Ish tugash (grafik tanlanmasa ishlatiladi)")
    grace_period_minutes = models.PositiveIntegerField(
        default=5,
        help_text="Ruxsat etilgan muhlat daqiqada (grafik tanlanmasa ishlatiladi)",
    )
